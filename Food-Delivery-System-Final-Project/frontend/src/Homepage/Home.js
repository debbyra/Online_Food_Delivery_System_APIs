...
function Home() {
  ...
  return (
    <div className="body">
      ...
      <div>
        <h1>
          we are dedicated to provide you with best quality food items.
        </h1>
      </div>
      <div className="order">
        <div className="sec1">
          ...
          ></img>
          <div className="word">
            <h3>For the most delicious local and international meals</h3>
          </div>
        </div>
        <div className="sec1">
          <img
          ...
          <div className="word">
            <h3>
              ...
              experience that will make your time with us fabulous.
            </h3>
          </div>
        </div>
      </div>
